...
<body >
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navHeaderCollapse">
				<ul class="nav navbar-nav navbar-right">
					<li class="active"><a id="a-home" href="${pageContext.request.contextPath}/index.html">Home</a></li>
					<li><a href="#">Blog</a></li>
					...
					<li><a id="a-logout-button" href="<c:url value="/j_spring_security_logout" />" >Logout</a> <br/></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="jumbotron">
			<h1 class="text-center">Second Admin page</h1>
			<p class="text-center">
				This page can be viewed anyone of users having rights of admin . It's not available for all users.<br />
			</p>
		</div>
	</div>
