...
<body >
	...
	<div class="container">
		<div class="well ">
			<ul> 
				<li><a href="${pageContext.request.contextPath}/sec/moderation.html"><h3>Moderation page</h3></a></li>
				<li><a href="${pageContext.request.contextPath}/admin/first.html"><h3>First Admin page</h3></a></li>
				<li><a href="${pageContext.request.contextPath}/admin/second.html"><h3>Second Admin page</h3></a></li>
			</ul>		
		</div>
	</div>
